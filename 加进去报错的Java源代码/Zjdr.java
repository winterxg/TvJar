...
public class Zjdr extends Spider {
    ...
    private Pattern regexPage = Pattern.compile("/vodshow/id/(\\d+)/page/(\\d+).html");

    @Override
    public void init(Context context) {
        super.init(context);
        try {
            playerConfig = new JSONObject("{\"XRJX\":{\"show\":\"追剧专享\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"csyun\":{\"show\":\"备用专享\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/playmv.vip\\/?url=\"},\"ccsm3u8\":{\"show\":\"自建三\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/op.m3u8zy.xyz\\/?url=\"},\"qq\":{\"show\":\"腾讯视频\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.qqqjx.com\\/?url=\"},\"qiyi\":{\"show\":\"奇艺视频\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.qqqjx.com\\/?url=\"},\"youku\":{\"show\":\"优酷视频\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.qqqjx.com\\/?url=\"},\"mgtv\":{\"show\":\"芒果视频\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.qqqjx.com\\/?url=\"},\"bilibili\":{\"show\":\"B站\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.qqqjx.com\\/?url=\"},\"lzm3u8\":{\"show\":\"第三方\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.m3u8zy.xyz\\/nk.php?url=\"},\"gsm3u8\":{\"show\":\"第四方\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/jx.m3u8zy.xyz\\/nk.php?url=\"},\"wjm3u8\":{\"show\":\"云播一\",\"des\":\"\",\"ps\":\"1\",\"parse\":\"https:\\/\\/www.lkvod.com\\/addons\\/dplayer\\/?url=\"}}");
    ...
    @@ -243,8 +243,8 @@ public String categoryContent(String tid, String pg, boolean filter, HashMap<Str
            ...
            if (!html.contains("没有找到您想要的结果哦")) {
                ...
                for (int i = 0; i < list.size(); i++) {
                    ...
                    String cover = vod.selectFirst("div.module-item-pic img.lazyload").attr("data-original");
    ...
    @@ -411,36 +411,36 @@ public String playerContent(String flag, String id, List<String> vipFlags) {
                ...
                if (scContent.startsWith("var player_")) { // 取直链
                    ...
                    if (playerConfig.has(player.getString("from"))) {
                        ...
                        if (videoUrl.contains(".m3u8")) {
                            ...
                            if (videoUrl.contains("mgtv") || videoUrl.contains("qq") || videoUrl.contains("youku") || videoUrl.contains("qiyi")) {
